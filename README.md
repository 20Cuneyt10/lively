...
By the end of this project we learned how and ADC works, how the Turtle library handles .goto() functions and how we can use our own loop for updating the screen with the audio values we mapped.